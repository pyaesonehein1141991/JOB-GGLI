...
import org.tat.gginl.api.domains.services.EntityService;
...
public class EntityScheduler {
	...
	@Scheduled(cron = "0 */5 * ? * *")
	public void createEntityFolder() throws Exception {
		...
		List<Object> columnNameList = entityService.findAllColumnName();
		List<Object[]> dataList = entityService.findAllNativeObject();

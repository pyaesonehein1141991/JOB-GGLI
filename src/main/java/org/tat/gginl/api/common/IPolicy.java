...
import org.tat.gginl.api.domains.ProductGroup;
...
public interface IPolicy {
	...
	/**
	 * The accessor to retrieve the prefix code which is being part of the
	 * unique ID.
	 * 
	 * @return the ID prefix of the policy
	 */
	...
	/**
	 * Accessor to retrieve the saleman who is responsible for this policy.
	 * 
	 * @return An instance of {@link SaleMan} associated
	 */

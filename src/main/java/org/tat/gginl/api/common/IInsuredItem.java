...
/**
 * The contract which defines the basic behaviors that all insured item implementations are obliged to comply.
 * 
 * @author ACN
 * @since 1.0.0
 * @date 2013/05/20
...
public interface IInsuredItem {
	...
	/**
	 * Accessor to retrieve the prefix code which is being part of the unique ID.
	 * 
	 ...
	 * 
	 * @return TODO: TBC with the project stake holders
	 */

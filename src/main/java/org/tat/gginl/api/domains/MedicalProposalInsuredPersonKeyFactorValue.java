...
@Entity
@Table(name = TableName.MEDICALPROPOSALINSUREDPERSONKEYFACTORVALUE)
...
public class MedicalProposalInsuredPersonKeyFactorValue {
	@Id
	...
	public MedicalProposalInsuredPersonKeyFactorValue() {
	}

	public MedicalProposalInsuredPersonKeyFactorValue(String value, KeyFactor keyFactor) {
		this.value = value;
		this.keyFactor = keyFactor;
	}

	public MedicalProposalInsuredPersonKeyFactorValue(MedicalPolicyInsuredPersonKeyFactorValue policyKeyFactorValue) {
		this.value = policyKeyFactorValue.getValue();
		this.keyFactor = policyKeyFactorValue.getKeyFactor();
	}

	public MedicalProposalInsuredPersonKeyFactorValue(KeyFactor keyFactor) {
		this.keyFactor = keyFactor;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MedicalProposalInsuredPersonKeyFactorValue other = (MedicalProposalInsuredPersonKeyFactorValue) obj;

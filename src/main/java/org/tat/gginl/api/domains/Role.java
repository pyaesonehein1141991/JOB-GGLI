...
@NamedQueries(value = {
		@NamedQuery(name = "Role.findAll", query = "SELECT m FROM Role m ORDER BY m.name ASC"),
...
public class Role implements Serializable {
	...
	@JoinTable(name = "ROLE_RESOURCE_ITEMS", joinColumns = { @JoinColumn(name = "ROLE_ID", referencedColumnName = "ID") }, inverseJoinColumns = { @JoinColumn(name = "RESITEM_ID", referencedColumnName = "ID") })

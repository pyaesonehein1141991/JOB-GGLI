...
public class SurveyQuestionAnswer {
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "surveyQuestionAnswer", orphanRemoval = true)
	...
	private ProposalInsuredPerson lifeproposalInsuredPerson;
	...
	public SurveyQuestionAnswer(SurveyQuestionAnswer surveyQuestion) {
	...
	public ProposalInsuredPerson getLifeproposalInsuredPerson() {
		return lifeproposalInsuredPerson;
	}

	public void setLifeproposalInsuredPerson(ProposalInsuredPerson lifeproposalInsuredPerson) {
		this.lifeproposalInsuredPerson = lifeproposalInsuredPerson;
	}

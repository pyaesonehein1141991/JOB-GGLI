...
@NamedQueries(value = {
		@NamedQuery(name = "PolicyInsuredPersonKeyFactorValue.findAll", query = "SELECT v FROM PolicyInsuredPersonKeyFactorValue v "),
...
public class PolicyInsuredPersonKeyFactorValue {
	...
	public PolicyInsuredPersonKeyFactorValue(
			InsuredPersonKeyFactorValue keyFactorValue) {
		this.value = keyFactorValue.getValue();
		this.keyFactor = keyFactorValue.getKeyFactor();
	}

	public PolicyInsuredPersonKeyFactorValue(
			PolicyInsuredPersonKeyFactorValue keyFactorValue) {
		this.value = keyFactorValue.getValue();
		this.keyFactor = keyFactorValue.getKeyFactor();
	}

	public PolicyInsuredPersonKeyFactorValue(
			PolicyInsuredPersonKeyFactorValueHistory keyFactorValue) {
		this.value = keyFactorValue.getValue();
		this.keyFactor = keyFactorValue.getKeyFactor();
	}
